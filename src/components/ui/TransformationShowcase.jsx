...
export default function TransformationShowcase() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-navy-950 via-slate-900 to-navy-900 text-white border border-navy-800 shadow-xl relative overflow-hidden">
        {/* Tricolour Subtle Top Line */}
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-1">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-2 leading-relaxed max-w-2xl font-medium">
              See how Kopargaon Fix transformed civic infrastructure. Genuine municipal project documentation from citizen detection to verified field delivery.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-shrink-0">
            <button
              ...
              className="px-5 py-3 rounded-xl bg-saffron-500 hover:bg-saffron-400 text-slate-950 text-xs sm:text-sm font-extrabold shadow-md shadow-saffron-500/20 transition-all flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="px-4 py-3 rounded-xl bg-slate-800/90 hover:bg-slate-700 text-white border border-slate-700 text-xs sm:text-sm font-semibold transition-colors flex items-center justify-center gap-2"
            >
        ...
        <div className="flex items-center gap-2 overflow-x-auto mt-6 pt-5 border-t border-slate-800/80 scrollbar-thin">
